...
function spotifyPlaylistEmbedUrl(url) {
  if (!url) return null
            ...
            <div className={"nav-slide-track" + (detailView === 'stories' ? ' nav-slide-track--stories' : '')}>
              ...
              <div className="nav-slide-panel">
                ...
                <div className="stories-scroll">
                  {isMusicFilter && spotifyPlaylistEmbedUrl(selectedCity.musicPlaylistSpotify) && (
                    <iframe
                      className="music-playlist-embed"
                      src={spotifyPlaylistEmbedUrl(selectedCity.musicPlaylistSpotify)}
                      width="100%"
                      height="352"
                      frameBorder="0"
